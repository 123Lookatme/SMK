CREATE DATABASE  IF NOT EXISTS `123lookatme` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `123lookatme`;
-- MySQL dump 10.13  Distrib 5.6.17, for Win32 (x86)
--
-- Host: 127.0.0.1    Database: 123lookatme
-- ------------------------------------------------------
...
CREATE TABLE `users` (
  ...
  `image` varchar(45) COLLATE utf8_unicode_ci DEFAULT 'default.png',
  PRIMARY KEY (`idusers`)
...
-- Dump completed on 2014-07-15 20:01:35
